...
<html>
	...
	<?php
		...
		if ($op==0) sel_tipo_prod();
		if ($op==1) f_Productos($op, $tipo_prod);
		if ($op==2) f_Productos($op, $tipo_prod);
		if ($op==3) f_Productos($op, $tipo_prod);
		if ($op==4) f_Productos($op, $tipo_prod);
		if ($op==5) f_Productos($op, $tipo_prod);
		...
		function f_Productos($op, $tipo_prod){
