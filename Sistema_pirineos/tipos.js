...
function prod_op_selec(op){
	...
	if (op==4) {
		...
		url="tipos.php?op=4&cve_tipo="+cve_tipo+"&nom_tipo="+nom_tipo;
		location.href=url;
	}
	if (op==5) {
		cve_tipo="5";
		nom_tipo="Derivados de Trigo"
		url="tipos.php?op=5&cve_tipo="+cve_tipo+"&nom_tipo="+nom_tipo;
		location.href=url;
	}
...
function altas(op){
	...
	if ((cve_tipo.length==0) || (nom_tipo.length==0)){
		...
		url="tipos.php?op=6&cve_tipo="+cve_tipo+"&nom_tipo="+nom_tipo+"&nom_catalog="+nom_catalog+"&nom_recetario="+nom_recetario;
...
function bajas(op){
	...
	if (cve_tipo.length==0){
		...
		if (confirm("Seguro de Eliminar ??")){
			url="tipos.php?op=7&cve_tipo="+cve_tipo+"&nom_tipo="+nom_tipo+"&nom_catalog="+nom_catalog+"&nom_recetario="+nom_recetario;
			url=url+"&nom_prod_rel1="+nom_prod_rel1+"&img_prod_rel1="+img_prod_rel1+"&url_prod_rel1="+url_prod_rel1;
			url=url+"&nom_prod_rel2="+nom_prod_rel2+"&img_prod_rel2="+img_prod_rel2+"&url_prod_rel2="+url_prod_rel2+"&cat="+cat;
			location.href=url;
		}
...
function consultas(op){
	...
	if (cve_tipo.length==0){
		...
		img_prod_rel2="";
		url_prod_rel2="";
		url="tipos.php?op=8&cve_tipo="+cve_tipo+"&nom_tipo="+nom_tipo+"&nom_catalog="+nom_catalog+"&nom_recetario="+nom_recetario;
		url=url+"&nom_prod_rel1="+nom_prod_rel1+"&img_prod_rel1="+img_prod_rel1+"&url_prod_rel1="+url_prod_rel1;
		url=url+"&nom_prod_rel2="+nom_prod_rel2+"&img_prod_rel2="+img_prod_rel2+"&url_prod_rel2="+url_prod_rel2+"&cat="+cat;
...
function cambios(op){
	...
	if (cve_tipo.length==0){
		...
		document.f_contenidos.cve_tipo.style.background="blue";
		url="tipos.php?op=9&cve_tipo="+cve_tipo+"&nom_tipo="+nom_tipo+"&nom_catalog="+nom_catalog+"&nom_recetario="+nom_recetario;
		url=url+"&nom_prod_rel1="+nom_prod_rel1+"&img_prod_rel1="+img_prod_rel1+"&url_prod_rel1="+url_prod_rel1;
		url=url+"&nom_prod_rel2="+nom_prod_rel2+"&img_prod_rel2="+img_prod_rel2+"&url_prod_rel2="+url_prod_rel2+"&cat="+cat;
		location.href=url;
	}
