...
<head>
    ...
    <link href = "styles/harinas_tres_estrellas.css" rel = "stylesheet">
...
<body>
    ...
    <div class = "container">
        ...
        <header class = "header">
            ...
            <img id = "header_image" src = "imagenes/Harinas Preparadas TE/Bizcocho.JPG">
                ...
                while ($reg=mysqli_fetch_object($sql)){ 
                    ...
                    echo "
                        <div>
                            ...
                            <h1> Descarga el PDF de Harinas Preparadas Tres Estrellas </h1>
